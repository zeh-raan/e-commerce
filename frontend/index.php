...
<body class="bg-gray-100">
  <header class="fixed top-0 left-0 w-full z-50 shadow-2xl rounded-b-2xl backdrop-blur-md bg-white/30 
                hover:bg-gray-900 hover:text-gray-200 transition-colors duration-300 animate-slide-down">
      ...
      <div class="flex items-center justify-between h-16">
        ...
        <form class="relative w-72">
          <input
            ...
            class="w-full pl-4 pr-10 py-2 rounded-full shadow-xl backdrop-blur-2xl hover:text-gray-200 placeholder-gray-400 transition-colors duration-300 focus:outline-none focus:ring-2 hover:bg-gray-700"
          >
          
          <!-- Icon inside input -->
          <div class="absolute inset-y-0 right-0 flex items-center pr-3 border-l border-gray-700 h-full">
        ...
        <div class="flex space-x-8 justify-center flex-1">
          <a href="#" class="hover:bg-gray-700 p-1 px-4 rounded-2xl transition-colors duration-300 font-medium">Home</a>
          <a href="#" class="hover:bg-gray-700 p-1 px-4 rounded-2xl transition-colors duration-300 font-medium">Catalog</a>
          <a href="#" class="hover:bg-gray-700 p-1 px-4 rounded-2xl transition-colors duration-300 font-medium">About Us</a>
        </div>

        <!-- Right: User & Cart -->
        <div class="flex items-center space-x-4">
          <a href="#" class="p-2 rounded-full hover:bg-gray-700 transition-colors duration-300">
